...
export const emptyHeat = (): HeatState => ({ cells: {}, points: {}, tanks: {}, devices: {}, balance: { input: 0, emitted: 0, pipeLoss: 0, tankLoss: 0, stored: 0 } })
...
export function stepHeat(model: Model, results: Results, prev: HeatState | null, dt: number): HeatState | null {
  ...
  const st: HeatState = { cells: {}, points: {}, tanks: {}, devices: {}, balance: { input: 0, emitted: 0, pipeLoss: 0, tankLoss: 0, stored: 0 } }
